 ...
 * @author franc
 */
public class ByPriceVendor extends javax.swing.JDialog {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(ByPriceVendor.class.getName());
    private Manager m;
    /**
     * Creates new form ByPrice
     */
    public ByPriceVendor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        m = new Manager();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                ByPriceVendor dialog = new ByPriceVendor(new javax.swing.JFrame(), true);
