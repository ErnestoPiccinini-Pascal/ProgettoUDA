 ...
 * @author franc
 */
public class ByLocationBuyer extends javax.swing.JDialog {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(ByLocationBuyer.class.getName());
    private Manager m;
    /**
     * Creates new form ByLocationBuyer
     */
    public ByLocationBuyer(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        m = new Manager();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                ByLocationBuyer dialog = new ByLocationBuyer(new javax.swing.JFrame(), true);
