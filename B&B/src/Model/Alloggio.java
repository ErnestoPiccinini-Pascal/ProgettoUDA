...
public class Alloggio {
    ...
    public Alloggio(String nome, String localita, int numeroCamere, double prezzo, ArrayList<String> servizi, String tipoAlloggio, boolean[] disponibilita, ArrayList<Recensione> recensioni) {
        this.nome = nome;
